...
public class BookFlight extends JFrame implements ActionListener {
    ...
    JTextField tfaadhar;
    JLabel tfname, tfaddress, labelgender, tfnationality, labelfcode, labelfname;
...
String query = "insert into reservation values('PNR-"+random.nextInt(1000000)+"', 'TIC-"+random.nextInt(10000)+"','"+aadhar+"','"+name+"','"+address+"','"+nationality+"','"+flightname+"','"+flightcode+"','"+src+"','"+dest+"','"+ddate+"')";
